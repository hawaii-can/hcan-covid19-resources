$(function() {
	...
	var vaccineURL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQm_HYq0rmBPR_Qc-M6F9IIJYTjv1aa4n-NRIodaVb4Jq64QVNeA89IPh80P_zbqQEDhcUB0Ab_Ju2Q/pub?gid=9793876&single=true&output=csv";
	...
	function init(vaccineData, testingData, housingFinancialData) {
		...
		var categories = createCategories(["Vaccines", "Testing"], "Everything", "#category-list-in-person");
	...
	function renderRows(data, prefix, usingLocation, appendEl, terms, rowCategory) {
		...
		_(data).each(function(row, index) {
			...
			console.log(rowCategory, row.Category, category);
